estoque = [
    {"id": 1, "produto": "Mouse Gamer", "categoria": "Periféricos", "preco": 120.00, "quantidade": 35, "fornecedor": "Logitech", "estoque_minimo": 10},
    {"id": 2, "produto": "Teclado Mecânico", "categoria": "Periféricos", "preco": 250.00, "quantidade": 20, "fornecedor": "Redragon", "estoque_minimo": 5},
    {"id": 3, "produto": "Monitor 24\"", "categoria": "Monitores", "preco": 890.00, "quantidade": 12, "fornecedor": "Samsung", "estoque_minimo": 3},
    {"id": 4, "produto": "HD 1TB", "categoria": "Armazenamento", "preco": 300.00, "quantidade": 40, "fornecedor": "Seagate", "estoque_minimo": 10},
    {"id": 5, "produto": "SSD 500GB", "categoria": "Armazenamento", "preco": 450.00, "quantidade": 25, "fornecedor": "Kingston", "estoque_minimo": 7},
    {"id": 6, "produto": "Placa de Vídeo RTX 3060", "categoria": "Componentes", "preco": 2500.00, "quantidade": 4, "fornecedor": "NVIDIA", "estoque_minimo": 2},
    {"id": 7, "produto": "Processador Ryzen 5", "categoria": "Componentes", "preco": 1200.00, "quantidade": 10, "fornecedor": "AMD", "estoque_minimo": 3},
    {"id": 8, "produto": "Gabinete RGB", "categoria": "Gabinetes", "preco": 350.00, "quantidade": 15, "fornecedor": "Gamemax", "estoque_minimo": 5},
    {"id": 9, "produto": "Fonte 650W", "categoria": "Energia", "preco": 480.00, "quantidade": 8, "fornecedor": "Corsair", "estoque_minimo": 4},
    {"id": 10, "produto": "Cooler CPU", "categoria": "Refrigeração", "preco": 150.00, "quantidade": 18, "fornecedor": "Cooler Master", "estoque_minimo": 6},
]
...
def main():
    ...
    if(isistance(optionSelecte, str)):
        if(optionSelected):
            pass;
    else:
...
def sum_by_item(name_to_filter, arr_estoque):
    items_categoria = [item for item in arr_estoque if item['categoria'] == name_to_filter]
    valor_total = sum(item['preco'] * item['quantidade'] for item in items_categoria)
